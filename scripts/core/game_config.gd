...
const SPRINTER_STALK_SPEED: float = 45.0
const SPRINTER_DASH_SPEED: float = 480.0
const SPRINTER_STALK_SECONDS: float = 1.6
const SPRINTER_TELEGRAPH_SECONDS: float = 0.6
const SPRINTER_DASH_MAX_SECONDS: float = 1.8
const SPRINTER_REST_SECONDS: float = 0.8
const SPRINTER_SPAWN_START_TIME: float = 30.0
const SPRINTER_SPAWN_CHANCE: float = 0.35
